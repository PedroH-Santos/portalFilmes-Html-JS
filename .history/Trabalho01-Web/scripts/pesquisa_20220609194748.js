...
let name = search.replace("?search=", "");



var xhttp = new XMLHttpRequest();
xhttp.open("GET", `${BASE_URL}movie/search/${id}?api_key=${CHAVE_API}&language=pt-BR&page=1&append_to_response=videos?query=${name}`, false);
xhttp.send();
